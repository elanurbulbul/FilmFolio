    ...
    <Box bg="gray.700" color="white" py={8}>
      <Flex direction="column" align="center" mx="auto" maxW="1200px" px={4}>
        <Stack direction="row" spacing={6} mb={8}>
          ...
          <Link href="https://vaibhav-more-portfolio-site.netlify.app/" _hover={{ color: "pink.400" }}>About</Link>
          <Link href="https://medium.com/@vaibhavmore24051997" _hover={{ color: "pink.400" }}>Blog</Link>
